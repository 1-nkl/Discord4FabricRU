...
public class Config {
    ...
    public String playerJoinMessage = "%player:name% присоединился к игре";
    public String playerJoinDescription = "Добро пожаловать на сервер :wave:";
    public String playerLeftMessage = "%player:name% покинул игру";
    public String playerLeftDescription = "До новых встреч :wave:";
    public Boolean announcePlayerDeath = true;
    public String deathMessage = "%d4f:reason%";
    public String deathDescription = "Повезёт в другой раз!";
    public Boolean announceAdvancement = true;
    public String advancementGoalTitle = "%player:name% выполнил достижение [%d4f:title%]";
    ...
    public String advancementChallengeTitle = "%player:name% выполнил достижение [%d4f:title%]";
    ...
    public String discordToMinecraftMessage = "[%d4f:nickname% из Discord] %d4f:message%";
    public String discordToMinecraftWithReplyMessage = "[%d4f:nickname% из Discord (отвечает игроку %d4f:reply_nickname%)] %d4f:message%";
    ...
    public String topic = "Онлайн: %server:online%/%server:max_players% | TPS сервера: %server:tps%";
