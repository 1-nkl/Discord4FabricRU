                            ...
                            .then(CommandManager.literal("link")
                                    .executes(context -> {
                                        ...
                                        switch (result) {
                                            ...
                                            case ACCOUNT_QUEUED -> context.getSource().sendError(Text.literal("Ваш аккаунт уже привязан! Ваш код привязки " + Discord4Fabric.ACCOUNT_LINKING.getCode(serverPlayer.getUuid())));
                                            case SUCCESS -> {
